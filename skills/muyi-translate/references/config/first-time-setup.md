...
description: First-time setup flow for muyi-translate preferences
---
...
options:
  - label: "User (Recommended)"
    description: "$HOME/.muyi-skills/muyi-translate/ (all projects)"
  - label: "Project"
    description: ".muyi-skills/muyi-translate/ (this project only)"
```
...
| Choice | Path | Scope |
|--------|------|-------|
| User | `$HOME/.muyi-skills/muyi-translate/EXTEND.md` | All projects |
| Project | `.muyi-skills/muyi-translate/EXTEND.md` | Current project |
